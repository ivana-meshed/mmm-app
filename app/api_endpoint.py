...
def handle_train_api():
    ...
    if st.query_params.get("api") == "train" and hasattr(st.session_state, "api_request_data"):
        ...
        try:
            ...
            job_id = request_data.get("job_id", f"api-job-{int(datetime.now().timestamp())}")
            ...
            job_config = {
                ...
                "paid_media_spends": request_data.get("paid_media_spends", ["GA_SUPPLY_COST"]),
                "paid_media_vars": request_data.get("paid_media_vars", ["GA_SUPPLY_COST"]),
                "context_vars": request_data.get("context_vars", ["IS_WEEKEND"]),
                "factor_vars": request_data.get("factor_vars", ["IS_WEEKEND"]),
                "organic_vars": request_data.get("organic_vars", ["ORGANIC_TRAFFIC"]),
                "api_mode": True
            }
