...
connect_page = st.Page("pages/0_Connect_Data.py", title="Connect Data", icon="🧩")
...
experiment_page = st.Page("pages/4_Run_Experiment.py", title="Run Experiment", icon="🧪")
results_page = st.Page("pages/5_View_Results.py", title="View Results", icon="📈")
best_results_page = st.Page("pages/6_View_Best_Results.py", title="Best Results", icon="🏆")
