...
def test_all_mode_includes_all_models():
    ...
    print(
        f"✓ All mode test passed: {len(good_models)} / {len(hyp_f)} models selected"
    )
...
def test_acceptable_mode_filters_correctly():
    ...
    print(
        f"✓ Acceptable mode test passed: {len(good_models)} / {len(hyp_f)} models selected"
    )
...
def test_good_mode_filters_strictly():
    ...
    print(
        f"✓ Good mode test passed: {len(good_models)} / {len(hyp_f)} models selected"
    )
