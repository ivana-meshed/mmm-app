...
class TestRevisionTagExtraction(unittest.TestCase):
    ...
    def test_extract_tag_from_path_ivana(self):
        ...
        self.assertGreaterEqual(len(parts), 2, "Path should have at least 2 parts")
    ...
    def test_extract_tag_from_path_multi_underscore(self):
        ...
        tag = parts[1].rsplit("_", 1)[0]
        self.assertEqual(tag, "team_alpha_test", "Should extract everything before last underscore")
    ...
    def test_path_without_underscore_skipped(self):
        ...
        self.assertFalse(has_underscore, "Old format 'r100' should not have underscore")
    ...
    def test_invalid_path_too_short(self):
        ...
        self.assertLess(len(parts), 2, "Short path should have less than 2 parts")
    ...
    def test_get_revision_tags_integration(self):
        ...
        mock_blobs = [
            ...
            MockBlob("robyn/r100/fr/0110_120000/file6.txt"),  # Old format, no underscore
        ]
        ...
        self.assertIn("baseline", tags_list, "'baseline' should be in the tags list")
        self.assertIn("experimental", tags_list, "'experimental' should be in the tags list")
        self.assertNotIn("r100", tags_list, "'r100' (old format) should not be in tags list")
        
        # Verify tags are sorted
        self.assertEqual(tags_list, sorted(tags_list), "Tags should be sorted alphabetically")
