...
\textbf{Production} & \textbf{10,000 × 5 = 50K} & \textbf{60 min} & \textbf{\$1.00} & \textbf{Production runs} \\
Large Production & 10,000 × 10 = 100K & 120 min & \$2.00 & High-quality runs \\
\bottomrule
\end{tabular}
...
\midrule
Light & 100 & 10 & \$4 & \$12 \\
Moderate & 500 & 50 & \$12 & \$52 \\
Heavy & 1,000 & 100 & \$22 & \$102 \\
Very Heavy & 5,000 & 500 & \$102 & \$502 \\
\bottomrule
\end{tabular}
...
\begin{itemize}
    \item Training jobs: \$0.20 (benchmark) to \$1.00 (production) per job
...
\begin{itemize}
    ...
    \item Cost per Job = \$0.20 (benchmark) or \$1.00 (production)
\end{itemize}

\textbf{Example:} 100 production jobs/month = \$2 + (100 × \$1.00) = \$102/month
